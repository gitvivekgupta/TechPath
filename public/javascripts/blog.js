...
for(var i=0; i<blogs.length; i++) {
    ...
    if(i%2 != 0) {  
        ...
        // ----small blog js
            ...
            small_blog_list.setAttribute('id', 'second-list'+i);
            ...
            // main div
                ...
                small_blog_list_div.setAttribute('id', 'second-list-div-one'+i);
                document.getElementById("second-list"+i).appendChild(small_blog_list_div);
                ...
                // first nested div
                    ...
                    small_blog_list_nested_div_one.setAttribute('id', 'second-list-nested-div-one'+i);
                    document.getElementById("second-list-div-one"+i).appendChild(small_blog_list_nested_div_one);

                        var small_blog_list_nested_div_one_atag = document.createElement("a");
                        small_blog_list_nested_div_one_atag.setAttribute('id', 'second-list-nested-div-one-atag'+i);
                        document.getElementById("second-list-nested-div-one"+i).appendChild(small_blog_list_nested_div_one_atag);

                            var small_blog_list_nested_div_one_imgtag = document.createElement("img");
                            document.getElementById("second-list-nested-div-one-atag"+i).appendChild(small_blog_list_nested_div_one_imgtag);
                            ...
                            // Second nested div
                                ...
                                small_blog_list_nested_div_two.setAttribute('id', 'second-list-nested-div-two'+i);
                                document.getElementById("second-list-div-one"+i).appendChild(small_blog_list_nested_div_two);
                                    ...
                                    small_blog_list_nested_div_two_ptag.setAttribute('id', 'small-add-date'+i);
                                    document.getElementById("second-list-nested-div-two"+i).appendChild(small_blog_list_nested_div_two_ptag);
                                    document.getElementById("small-add-date"+i).innerHTML = blog_date; // Add Date-------------
                                        ...
                                        small_blog_list_nested_div_two_head.setAttribute('id', 'second-list-nested-div-two-headtag'+i);
                                        document.getElementById("second-list-nested-div-two"+i).appendChild(small_blog_list_nested_div_two_head);

                                            var small_blog_list_nested_div_two_atag = document.createElement("a");
                                            small_blog_list_nested_div_two_atag.setAttribute('id', 'small-add-heading'+i);
                                            document.getElementById("second-list-nested-div-two-headtag"+i).appendChild(small_blog_list_nested_div_two_atag);
                                            document.getElementById("small-add-heading"+i).innerHTML = blog_title;  // Add title--------------

                                            // second nested div -- nested div
                                                ...
                                                small_blog_list_nested_div_three.setAttribute('id', 'second-list-nested-div-two-nested-div'+i);
                                                document.getElementById("second-list-nested-div-two"+i).appendChild(small_blog_list_nested_div_three);

                                                    var small_blog_list_card_content_nested_div_one_atag = document.createElement("a");
                                                    small_blog_list_card_content_nested_div_one_atag.setAttribute('id', 'second-list-nested-div-two-nested-div-atag'+i);
                                                    document.getElementById("second-list-nested-div-two-nested-div"+i).appendChild(small_blog_list_card_content_nested_div_one_atag);

                                                        var small_blog_list_card_content_nested_div_one_imgtag = document.createElement("img");
                                                        document.getElementById("second-list-nested-div-two-nested-div-atag"+i).appendChild(small_blog_list_card_content_nested_div_one_imgtag);
